...
This experiment was created using PsychoPy3 Experiment Builder (v2024.2.5),
    on Fri 08 Aug 2025 18:25:05 CEST
...
expName = 'mlds_experiment_numerosity_triads'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/home/guille/git/ecvp2025-mlds-mlcm-tutorial/experiment/mlds_experiment_numerosity_triads_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    instrText = visual.TextBox2(
         win, text='Perceived numerosity\n\nChoose which pair of stimuli look\nmore different in their numerosity\n\nPress the Left arrow for the left-middle pair\nPress the Right Down to chose the right-middle pair\n\nPress any key to continue\nPress Esc to quit', placeholder='Type here...', font='Arial',
         ori=0.0, pos=(0, 0), draggable=False,      letterHeight=0.05,
         size=(0.9, 0.9), borderWidth=2.0,
    ...
    image1 = visual.ImageStim(
        ...
        ori=0.0, pos=(0.25, -0.125), draggable=False, size=(0.25, 0.25),
    ...
    image2 = visual.ImageStim(
        ...
        name='image2', 
        image='default.png', mask=None, anchor='center',
        ori=0.0, pos=(0.0, 0.25), draggable=False, size=(0.25, 0.25),
        color=[1,1,1], colorSpace='rgb', opacity=None,
        flipHoriz=False, flipVert=False,
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions(f"design/block_{expInfo['session']}.csv"), 
        seed=None, 
    )
    ...
    for thisTrial in trials:
        ...
        trial = data.Routine(
            name='trial',
            components=[resp, image1, image2, image3],
        )

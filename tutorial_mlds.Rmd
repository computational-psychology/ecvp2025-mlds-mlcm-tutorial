...
```{r}
mns <- scale.bt.res[, 1] # bootstrap mean
ci <- qnorm(0.975) * scale.bt.res[, 2] # 95 CI, assuming normal distribution of bootstrap samples
...
We now plot the scale with CIs

...
The variables `low` and `high`contains the CI bounds. We now can plot the scale with CIs
...
Experimenters may consider alternative models to investigate these cases further.

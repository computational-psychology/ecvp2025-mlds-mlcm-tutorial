...
This experiment was created using PsychoPy3 Experiment Builder (v2025.1.1),
    on Wed 20 Aug 2025 17:38:39 CEST
...
expName = 'mlcm_experiment_whites_illusion'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/home/guille/git/ecvp2025-mlds-mlcm-tutorial/experiment-mlcm/mlcm_experiment_whites_illusion_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    instrText = visual.TextBox2(
         win, text="MLCM and White's illusion\n\nChoose which target looks BRIGHTER.\n(target positions are indicated with an asterisk on the bottom)\n\nPress the LEFT or RIGHT arrow\n\nPress any key to continue\nPress Esc to quit", placeholder='Type here...', font='Arial',
    ...
    image = visual.ImageStim(
        ...
        ori=0.0, pos=(0, 0), draggable=False, size=[0.65, 0.5],
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions(f"block_{expInfo['session']}.csv"), 
        seed=None, 
    )

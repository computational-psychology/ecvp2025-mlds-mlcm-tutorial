/**************************************** 
 * Mlcm_Experiment_Whites_Illusion *
 ****************************************/
...
let expName = 'mlcm_experiment_whites_illusion';  // from the Builder filename that created this script
let expInfo = {
    'session': '1',
    'participant': '',
};
...
function trialsLoopBegin(trialsLoopScheduler, snapshot) {
  return async function() {
    ...
    trials = new TrialHandler({
      ...
      trialList: `block_${expInfo["session"]}.csv`,
